...
Start by adding a new code block here (copy/paste above or CTRL-ALT-I). Then add on to the code in the previous slide to determine the average number of orders per patient *and per department*.
