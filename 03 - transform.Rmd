...
Now  add `order_class_c_descr` as a second (tie breaking) variable to arrange on, but order it in reverse alphabetical order. Explore what type of order class appears in the first rows of the data frame. Based on the description column, to what type of lab test does this order class seem to relate to?


```{r}
arrange(orders, result_time)

arrange(orders, (order_status_c_descr)) %>% View
...
1. Filter orders to just the girls that were born in 2015  
