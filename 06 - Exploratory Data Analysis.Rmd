...
5. What is the difference between the "value" and "valuenum" columns?


## Exercise 2

I like to start my EDA by testing my assumptions about the data set. The mimic data frame has results data for ICU patients. We will use some simple dplyr functions to better understand the patterns of data in the mimic data frame.
