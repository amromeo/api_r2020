...
The *pan_day* variable holds the day of the pandemic (an arbitrary day in late February of 2020) on which the COVID test order was placed. What would be an appropriate binwidth for *pan_day*? 
...
Read the code below and try to predict what it will do when run. 
